...
const Header = () => {
  ...
  if (authToken) {
    ...
    userAvatar = decodedToken.avatar; // Assuming 'avatar' is the key in your JWT payload for the avatar URL
  }
      ...
      <header className="header">
        ...
        {authToken ? (
            <div className="login-button">
              ...
              <IconButton onClick={handleMenuClick}>
                <Avatar alt="User Avatar" src={userAvatar} className="avatar" sx={{ width: 50, height: 50 }} />
              </IconButton>
              <Menu
                  anchorEl={anchorMenu}
        ...
        <Dialog open={openCreateEventDialog} onClose={handleCreateEventDialogClose} maxWidth="xs" fullWidth={false}>
          ...
          <DialogContent>
            ...
            <Box hidden={tabValue !== 0 || !authToken} marginTop={2}>
              <Typography>
            ...
            <Box hidden={tabValue !== 0 || authToken} marginTop={2}>
              <Typography>
                Чтобы создать открытое событие необходимо войти в свой аккаунт или зарегистрироваться.
              </Typography>
            </Box>
            {authToken ? (
